...
def test_plot_inline_no_parameter(setup_postgres, plot):
...
def test_plot_static(setup_postgres, plot, tmp_path):
    data = plot.plot_signal(
        source_name="source_1_1", parameter_name="parameter_1", plot_dynamic=False
    )


def test_plot_list_of_parameters(setup_postgres, plot, tmp_path):
    data = plot.plot_signal(
        source_name="source_1_1",
        parameter_name=["parameter_1", "parameter_2"],
        auto_open=False,
        filename=str(tmp_path / "test.html"),
    )
...
def test_plot_with_meta_not_inline_parameter_list(setup_postgres, plot, tmp_path):
    data, meta = plot.plot_signal_with_meta(
        source_name="source_1_1",
        parameter_name=["parameter_1", "parameter_2"],
        site_name="site_1",
