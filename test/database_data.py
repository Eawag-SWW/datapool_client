DB_DATA = {
    ...
    "parameter": [
        {"parameter_id": "1", "name": "parameter_1", "description": "desc to p1"},
        {"parameter_id": "2", "name": "parameter_2", "description": "desc to p2"},
        {"parameter_id": "3", "name": "parameter_3", "description": "desc to p3"},
    ],
    "source_type": [
